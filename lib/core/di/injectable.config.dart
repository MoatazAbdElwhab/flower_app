...
import 'package:flower_app/core/app_data/api/graphql/graphql_client.dart'
    as _i285;
import 'package:flower_app/core/app_data/api/graphql/graphql_error_handler.dart'
    as _i765;
import 'package:flower_app/core/app_data/api/graphql/graphql_provider.dart'
    as _i267;
...
import 'package:flower_app/features/auth/data/datasource/local_data_source/auth_local_data_source_impl.dart'
    as _i851;
import 'package:flower_app/features/auth/data/datasource/remote_data_source/auth_graphql_data_source_impl.dart'
    as _i965;
import 'package:flower_app/features/auth/data/datasource/remote_data_source/auth_remote_data_source_contract.dart'
    as _i851;
import 'package:flower_app/features/auth/data/repository/auth_repo_impl.dart'
    as _i533;
...
import 'package:flower_app/features/auth/domain/ues_case/reset_password_use_case.dart'
    as _i696;
import 'package:flower_app/features/auth/domain/ues_case/sign_in_as_guest_use_case.dart'
    as _i239;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i974.Logger>(() => getItRegisterModule.logger);
    gh.singleton<_i765.GraphQLErrorHandler>(
        () => getItRegisterModule.provideGraphQLErrorHandler());
    gh.singleton<_i210.AppNavigatorObserver>(
        () => _i210.AppNavigatorObserver());
    gh.singleton<_i271.DialogUtils>(() => _i271.DialogUtils());
    gh.lazySingleton<_i674.NavCubit>(() => _i674.NavCubit());
    gh.singleton<_i666.LocalStorageClient>(() => _i666.LocalStorageClient(
          gh<_i460.SharedPreferences>(),
          gh<_i558.FlutterSecureStorage>(),
        ));
    gh.singleton<_i285.GraphQLConfig>(() => getItRegisterModule
        .provideGraphQLConfig(gh<_i666.LocalStorageClient>()));
    ...
    await gh.singletonAsync<_i267.AppGraphQLProvider>(
      () =>
          getItRegisterModule.provideGraphQLProvider(gh<_i285.GraphQLConfig>()),
      preResolve: true,
    );
    gh.singleton<_i941.GraphQLService>(() => getItRegisterModule
        .provideGraphQLService(gh<_i267.AppGraphQLProvider>()));
    gh.singleton<_i128.GraphQLClient>(() => getItRegisterModule
        .provideGraphQLClient(gh<_i267.AppGraphQLProvider>()));
    gh.factory<_i286.HomeDataSourceContract>(
        () => _i399.HomeDataSourceImpl.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i224.OccasionRemoteDataSource>(() =>
        _i540.OccasionApiRemoteDataSource.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i851.AuthRemoteDataSourceContract>(
        () => _i965.AuthGraphQLDataSourceImpl.from(gh<_i941.GraphQLService>()));
    gh.factory<_i453.HomeRepositoryContract>(
        () => _i779.HomeRepositoryImpl(gh<_i286.HomeDataSourceContract>()));
    gh.factory<_i861.CartRemoteDsInterface>(() => _i845.CartRemoteDsImpl(
          gh<_i941.GraphQLService>(),
          gh<_i974.Logger>(),
        ));
    gh.factory<_i717.SearchRemoteDsInterface>(
        () => _i261.SearchRemoteDsImpl.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i445.ProfileRemoteDataSource>(() =>
        _i1015.ProfileApiRemoteDataSource.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i766.CheckoutRemoteDataSource>(() =>
        _i526.CheckoutApiRemoteDataSource.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i634.CategoriesRemoteDataSourceContract>(() =>
        _i161.CategoriesRemoteDataSourceImpl.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i517.AddAddressRemoteDataSource>(() =>
        _i570.AddAddressRemoteDataSourceImpl.create(gh<_i128.GraphQLClient>()));
    gh.factory<_i646.AddAddressRepo>(
        () => _i944.AddAddressRepoImpl(gh<_i517.AddAddressRemoteDataSource>()));
    gh.factory<_i514.AuthRepo>(() => _i533.AuthRepoImpl(
          gh<_i851.AuthRemoteDataSourceContract>(),
          gh<_i1053.AuthLocalDataSourceContract>(),
          gh<_i267.AppGraphQLProvider>(),
          gh<_i974.Logger>(),
        ));
    ...
    gh.factory<_i239.SignInAsGuestUseCase>(
        () => _i239.SignInAsGuestUseCase(gh<_i514.AuthRepo>()));
